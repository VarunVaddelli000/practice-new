...
export default function ProductDescription() {
    ...
    const filteredProducts1 = products.find(filteredProduct => filteredProduct.id === +productId);
    console.log(filteredProducts1)
    return (
        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6 flex  items-start mb-2">
            <div >
                {/* Safely check if ProductDescription exists and has at least one item */}
                <div className="border-slate-300 border-b-4 ">
                    <p className="font-semibold text-xl">{filteredProducts1.ProductDescription && filteredProducts1.ProductDescription.length > 0 ? filteredProducts1.ProductDescription[0].name1 : 'No description available'}</p>
                    <p className="mb-2">{filteredProducts1.ProductDescription && filteredProducts1.ProductDescription.length > 0 ? filteredProducts1.ProductDescription[0].details1 : 'No description available'}</p>
                </div>
                <div className="mt-2">
                    <p className="font-semibold text-xl">{filteredProducts1.ProductDescription && filteredProducts1.ProductDescription.length > 0 ? filteredProducts1.ProductDescription[0].name2 : 'No description available'}</p>
                    <p>{filteredProducts1.ProductDescription && filteredProducts1.ProductDescription.length > 0 ? filteredProducts1.ProductDescription[0].details2 : 'No description available'}</p>
                </div>
            </div>
            <Outlet /> 
        </div>
